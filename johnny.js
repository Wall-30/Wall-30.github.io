...
// Function to update high score based on a unique page identifier
...
// Call the function with different page identifiers based on the page
updateHighScore('page1');  // For page 1
updateHighScore('page2');  // For page 2
updateHighScore('page3');  // For page 3
